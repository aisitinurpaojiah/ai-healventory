...
<aside class="sidebar">
    ...
    <ul class="menu">
        <li class="<?= ($current_page == 'dashboard_staff.php') ? 'active' : '' ?>" data-page="dashboard_staff.php">
            <i class="bi bi-house-door-fill"></i>
            <span>Beranda</span>
        </li>
        <li class="<?= ($current_page == 'transaksi_staff.php') ? 'active' : '' ?>" data-page="transaksi_staff.php">
